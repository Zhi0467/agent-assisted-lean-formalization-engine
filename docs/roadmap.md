...
`ef80610`). That branch adds proof-gated enrichment/plan flow, backend-owned
...
Status: in progress on draft PR `#6` (`bbd6b00`, with latest code fix `ef80610`).
