...
- `PYTHONPATH=src python3 -m unittest discover -s tests` (`122` tests, all passing on PR `#6` head `ef80610`)
...
- [ ] Wait for fresh review feedback on PR `#6` head `ef80610`, then either merge the Terry review / proof-gating branch or take the next concrete follow-up it surfaces.
